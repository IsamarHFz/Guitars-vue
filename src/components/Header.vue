...
defineEmits(['quita-uno', 'quita-guitarra', 'vaciar-carrito', 'agrega-uno'])
</script>
    ...
    <div class="container-xl">
      <div class="row justify-content-center justify-content-md-between">
        <div class="col-8 col-md-3">
          <a href="index.html">
            <img class="img-flu id" src="/img/logo.svg" alt="imagen logo" />
          </a>
        </div>
        <nav
                  ...
                  <tbody>
                    <tr v-for="guitarra in carrito">
                      ...
                      <td class="flex align-items-start gap-4">
                        <button type="button" 
                        class="btn btn-dark"
                        @click="$emit('quita-uno', guitarra.id)">-</button>
                        {{ guitarra.cantidad }}
                        <button type="button" class="btn btn-dark"
                        @click="$emit('agrega-uno', guitarra.id)">+</button>
                      </td>
                      <td>
                        <button class="btn btn-danger"
                        type="button" 
                        @click="$emit('quita-guitarra', guitar)">X</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
